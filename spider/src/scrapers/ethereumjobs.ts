// ============================================================
// RemoteWeb3 Spider - Ethereum Job Board Scraper
// ============================================================
...
export class EthereumJobsScraper extends BaseScraper {
  constructor() {
    super({
      name: 'ethereumjobboard.com',
      baseUrl: 'https://www.ethereumjobboard.com',
      jobListUrl: 'https://www.ethereumjobboard.com/jobs',
    });
  }
  ...
  async scrape(): Promise<ScrapeResult> {
    ...
    try {
      ...
      for (let page = 1; page <= MAX_PAGES; page++) {
        ...
        const cards = $(
          'a[href*="/job/"], a[href*="/jobs/"], .job-card, .job-listing, .job-item, article.job, [class*="job-card"], [class*="job-listing"], .listing-item, .position-item'
        ).toArray();
        ...
        for (const el of cards) {
          ...
          try {
            ...
            const existing = await checkJobExists(sourceId, 'ethereumjobboard.com');
            if (existing) {
            ...
            const job: ScrapedJob = {
              ...
              department: typeText || undefined,
              application_url: sourceUrl,
              source_site: 'ethereumjobboard.com',
